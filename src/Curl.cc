...
const std::vector<CurlConstant> curlOptionInteger = {
    ...
    {"HTTP2_WINDOW_UPDATE", CURLOPT_HTTP2_WINDOW_UPDATE},
    {"TLS_GREASE", CURLOPT_TLS_GREASE},
    {"STREAM_EXCLUSIVE", CURLOPT_STREAM_EXCLUSIVE},
    {"TLS_KEY_USAGE_NO_CHECK", CURLOPT_TLS_KEY_USAGE_NO_CHECK},
    {"TLS_SIGNED_CERT_TIMESTAMPS", CURLOPT_TLS_SIGNED_CERT_TIMESTAMPS},
    {"TLS_STATUS_REQUEST", CURLOPT_TLS_STATUS_REQUEST},
    {"TLS_RECORD_SIZE_LIMIT", CURLOPT_TLS_RECORD_SIZE_LIMIT},
    {"TLS_KEY_SHARES_LIMIT", CURLOPT_TLS_KEY_SHARES_LIMIT},
    {"TLS_USE_NEW_ALPS_CODEPOINT", CURLOPT_TLS_USE_NEW_ALPS_CODEPOINT},
    {"HTTP2_NO_PRIORITY", CURLOPT_HTTP2_NO_PRIORITY},
    {"PROXY_CREDENTIAL_NO_REUSE", CURLOPT_PROXY_CREDENTIAL_NO_REUSE},
    {"SPLIT_COOKIES", CURLOPT_SPLIT_COOKIES},
    {"WS_SSL_DISABLE_TICKET", CURLOPT_WS_SSL_DISABLE_TICKET},
    {"HTTP3_SSL_PERMUTE_EXTENSIONS", CURLOPT_HTTP3_SSL_PERMUTE_EXTENSIONS},
#endif
};
...
const std::vector<CurlConstant> curlOptionLinkedList = {
    ...
    {"HTTP3_HTTPHEADER", CURLOPT_HTTP3_HTTPHEADER},
    {"WS_HTTPHEADER", CURLOPT_WS_HTTPHEADER},
#endif
};
...
const std::vector<CurlConstant> curlOptionString = {
    ...
    {"HTTP2_SETTINGS", CURLOPT_HTTP2_SETTINGS},
    {"HTTP2_STREAMS", CURLOPT_HTTP2_STREAMS},
    {"TLS_EXTENSION_ORDER", CURLOPT_TLS_EXTENSION_ORDER},
    {"TLS_DELEGATED_CREDENTIALS", CURLOPT_TLS_DELEGATED_CREDENTIALS},
    {"FORM_BOUNDARY", CURLOPT_FORM_BOUNDARY},
    {"HTTP3_PSEUDO_HEADERS_ORDER", CURLOPT_HTTP3_PSEUDO_HEADERS_ORDER},
    {"HTTP3_SETTINGS", CURLOPT_HTTP3_SETTINGS},
    {"QUIC_CID_LENGTH", CURLOPT_QUIC_CID_LENGTH},
    {"QUIC_TRANSPORT_PARAMETERS", CURLOPT_QUIC_TRANSPORT_PARAMETERS},
    {"HTTP3_SIG_HASH_ALGS", CURLOPT_HTTP3_SIG_HASH_ALGS},
    {"HTTP3_TLS_EXTENSION_ORDER", CURLOPT_HTTP3_TLS_EXTENSION_ORDER},
    {"HTTPHEADER_ORDER", CURLOPT_HTTPHEADER_ORDER},
    {"HTTP3_HTTPHEADER_ORDER", CURLOPT_HTTP3_HTTPHEADER_ORDER},
    {"HTTP3_SSL_EC_CURVES", CURLOPT_HTTP3_SSL_EC_CURVES},
    {"WS_HTTPHEADER_ORDER", CURLOPT_WS_HTTPHEADER_ORDER},
    {"WS_SSL_CERT_COMPRESSION", CURLOPT_WS_SSL_CERT_COMPRESSION},
    {"TLS_TRUST_ANCHORS", CURLOPT_TLS_TRUST_ANCHORS},
