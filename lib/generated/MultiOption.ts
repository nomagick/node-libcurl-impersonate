 ...
 */
// This file was generated by scripts/build-constants.js on 2026-08-07T10:29:23.932Z
...
export interface MultiOption {
  ...
  /**
   * Enable a quicker cleanup of the multi handle.
   *
   * Official libcurl documentation: [https://curl.haxx.se/libcurl/c/CURLMOPT_QUICK_EXIT.html](https://curl.haxx.se/libcurl/c/CURLMOPT_QUICK_EXIT.html)
   */
  readonly QUICK_EXIT: 'QUICK_EXIT'

  /**
   * Max threads used for threaded DNS resolver.
   *
   * Official libcurl documentation: [https://curl.haxx.se/libcurl/c/CURLMOPT_RESOLVE_THREADS_MAX.html](https://curl.haxx.se/libcurl/c/CURLMOPT_RESOLVE_THREADS_MAX.html)
   */
  readonly RESOLVE_THREADS_MAX: 'RESOLVE_THREADS_MAX'
}
