 ...
 */
// This file was generated by scripts/build-constants.js on 2026-09-03T07:37:25.700Z
...
export interface CurlInfo {
  ...
  /**
   * The time it took from the start until the file transfer is about to begin. This includes all pre-transfer commands and negotiations that are specific to the particular protocol(s) involved.
   *
  ...
  /**
   * The time it took from the start until the file transfer is about to begin. This includes all pre-transfer commands and negotiations that are specific to the particular protocol(s) involved. In microseconds.
   *
  ...
  /**
   * The time it took for all redirection steps include name lookup, connect, pretransfer and transfer before final transaction was started. This is zero if no redirection took place. As a double.
   *
  ...
  /**
   * The time it took for all redirection steps include name lookup, connect, pretransfer and transfer before final transaction was started. This is zero if no redirection took place. In number of microseconds.
   *
   ...
   *
   * Official libcurl documentation: [https://curl.haxx.se/libcurl/c/CURLINFO_SIZE_DELIVERED.html](https://curl.haxx.se/libcurl/c/CURLINFO_SIZE_DELIVERED.html)
   */
  readonly SIZE_DELIVERED: 'SIZE_DELIVERED'
  ...
  /**
   * curl-impersonate: accepted server cookie mutations from the latest transfer, formatted as SET/DELETE plus Netscape cookie fields. Use a high number to avoid collisions with upstream infos.
   *
   * Official libcurl documentation: [https://github.com/lexiforest/curl-impersonate/blob/8e674f96ebae13cdc97b488abb45283e99bd3571/patches/curl.patch#L963](https://github.com/lexiforest/curl-impersonate/blob/8e674f96ebae13cdc97b488abb45283e99bd3571/patches/curl.patch#L963)
   */
  readonly COOKIECHANGES: 'COOKIECHANGES'
   ...
   *
   * Official libcurl documentation: [https://github.com/lexiforest/curl-impersonate/blob/8e674f96ebae13cdc97b488abb45283e99bd3571/patches/curl.patch#L967](https://github.com/lexiforest/curl-impersonate/blob/8e674f96ebae13cdc97b488abb45283e99bd3571/patches/curl.patch#L967)
   */
  readonly REDIRECT_HISTORY: 'REDIRECT_HISTORY'
}
